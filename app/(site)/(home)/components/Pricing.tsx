        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex bg-gradient-to-r from-[#ffffff56] to-[#FFFFFF10] rounded-xl border border-white/10 mt-6">
            <div
              ...
              } cursor-pointer w-[125px] h-[56px] text-xl font-semibold grid place-content-center transition-colors duration-200 rounded-lg`}>
              Monthly
            </div>
            <div
        ...
        <div className="flex gap-10 mt-16">
          {packageData.map((pack, index) => (
            <div
              ...
              } form-border-gradient w-full p-10 rounded-[40px] min-h-[695px] flex flex-col justify-between relative overflow-hidden`}>
              {pack.isPopular && (
